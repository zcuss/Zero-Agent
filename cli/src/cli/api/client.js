...
const CLI_TOKEN_HEADER = "x-zero-cli-token";
const CLI_TOKEN_SALT = "zero-cli-auth";
 ...
 * @returns {Promise<Object>} { success, data: { installed, hasZeroAgent, ... } }
 */
