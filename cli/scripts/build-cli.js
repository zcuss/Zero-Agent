...
console.log("📦 Building Zero Agent CLI package with Next.js...\n");
...
// Strip better-sqlite3 (native) — it lives in ~/.zero-agent/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.zero-agent/runtime)");
}
console.log("");
