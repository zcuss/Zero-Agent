...
Settings → Models → Advanced:
  OpenAI API Base URL: http://localhost:20130/v1
...
```json
{
  "anthropic_api_base": "http://localhost:20130/v1",
...
```bash
export OPENAI_BASE_URL="http://localhost:20130"
...
export NEXT_PUBLIC_BASE_URL="http://localhost:20130"
...
docker run -d --name 9router -p 20130:20130 \
...
| `PORT` | framework default | Service port (`20130` in examples) |
| `HOSTNAME` | framework default | Bind host (Docker defaults to `0.0.0.0`) |
| `NODE_ENV` | runtime default | Set `production` for deploy |
| `BASE_URL` | `http://localhost:20130` | Server-side internal base URL used by cloud sync jobs |
...
- Set `PORT=20130` and `NEXT_PUBLIC_BASE_URL=http://localhost:20130`
