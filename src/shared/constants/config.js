...
export const APP_CONFIG = {
  name: "Zero Agent",
  description: "Dark developer dashboard for AI infrastructure",
  version: pkg.version,
};

// GitHub configuration
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/decolua/zero-agent/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://zero-agent.local/api/donate",
};
